...
class Staff_model extends MY_Model
{
    ...
    public function getEmployee($role, $active = 1, $condition = null)
    {
        $i             = 1;
        ...
        if (!empty($student_current_class->class_id)) {
