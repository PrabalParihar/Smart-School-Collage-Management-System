                                           ...
                                           <span style="display:none;" id="ratevalue"> <?php echo  $value['rate'] ; ?></span>
                                            ...
                                            if($this->rbac->hasPrivilege('teachers_rating','can_edit')){
                                                ...
                                                if($this->rbac->hasPrivilege('teachers_rating','can_delete')){
                                                    ?>
                                                     <a class="btn btn-default btn-xs" data-toggle="tooltip" title="delete"  onclick="return confirm('<?php echo $this->lang->line('delete_confirm');?>');" href="<?php echo base_url();?>admin/Staff/delete_rateing/<?php echo $value['rate_id']?>"><i class="fa fa-remove"></i></a>
                                                    <?php
                                                }
                                                ?>
