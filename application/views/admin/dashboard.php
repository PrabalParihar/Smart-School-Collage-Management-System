            ...
            ?>
             <div class="col-lg-3 col-md-6 col-sm-6">
              <div class="topprograssstart">
                <p class="text-uppercase mt5 clearfix"><i class="fa fa-money ftlayer"></i><?php echo $this->lang->line('fees')." ".$this->lang->line('awaiting')." ".$this->lang->line('payment');?><span class="pull-right"><?php echo $total_paid+0; ?>/<?php echo $total_fees?></span>
               </p>
                            ...
                            <div class="info-box">
                                <a href="<?php echo site_url('studentfee') ?>">
                                    ...
                                    <div class="info-box-content">
                                        ...
                                        <span class="info-box-number"><?php echo $this->customlib->getSchoolCurrencyWithPlace($month_collection); ?></span>
                                    </div>
                                </a>
                            </div>
                        </div>
                            ...
                            <div class="info-box">
                                <a href="<?php echo site_url('admin/expense') ?>">
                                    ...
                                    <div class="info-box-content">
                                        ...
                                        <span class="info-box-number"><?php echo $this->customlib->getSchoolCurrencyWithPlace($month_expense); ?></span>
                                    </div>
                                </a>
                            </div>
                        </div>
