<div class="content-wrapper" style="min-height: 348px;">  
    ...
    <section class="content">
        ...
        <?php if ($this->rbac->hasPrivilege('visitor_book', 'can_delete')) { ?>
            ...
            <?php } else { ?>
                                                            <a data-placement="left" href="<?php echo base_url(); ?>admin/visitors/delete/<?php echo $value['id']; ?>" class="btn btn-default btn-xs" data-toggle="tooltip" title="" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');" data-original-title="Delete">
                                                                <i class="fa fa-remove"></i>
                                                            </a>
            <?php }
        }
