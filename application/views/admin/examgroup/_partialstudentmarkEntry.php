...
foreach ($attendence_exam as $attendence_key => $attendence_value) {
            ...
            ?>
                                ...
                                <td> <input type="number" class="marksssss form-control" name="exam_group_student_mark_<?php echo $student['exam_group_class_batch_exam_students_id']; ?>" value="<?php echo $student['exam_group_exam_result_get_marks']; ?>"></td>
