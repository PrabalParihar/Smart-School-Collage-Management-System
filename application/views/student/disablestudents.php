                                        ...
                                        if (empty($resultlist)) {
                                            ...
                                            foreach ($resultlist as $student) {
                                                ...
                                                <tr>
													...
													<?php } ?>
                                                         <td><span data-toggle="popover" class="detail_popover" data-original-title="" title=""><?php if (array_key_exists($reason_id,$disable_reason))
  { echo $disable_reason[$reason_id]['reason']; } ?></span>
