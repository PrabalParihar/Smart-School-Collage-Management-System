            ...
            <div class="col-md-4">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"><?php echo $this->lang->line('add_fee_category'); ?></h3>
                    </div><!-- /.box-header -->
                    <form id="form1" action="<?php echo base_url() ?>feecategory"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                        <div class="box-body">
