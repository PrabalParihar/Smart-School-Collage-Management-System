...
?>";
                                        ...
                                        $calendar.fullCalendar({
                                            ...
                                            events: {
                                                url: base_url + 'parent/calendar/getevents'
                                        ...
                                        function edit_todo_task(eventid) {
                                            ...
                                            $.ajax({
                                                url: "<?php echo site_url("parent/calendar/gettaskbyid/") ?>" + eventid,
                                                type: "POST",
                                        ...
                                        $(document).ready(function (e) {
                                            ...
                                            $("#addtodo_form").on('submit', (function (e) {
                                                ...
                                                e.preventDefault();
                                                $.ajax({
                                                    url: "<?php echo site_url("parent/calendar/addtodo") ?>",
                                                    type: "POST",
...
function deleteevent(id, msg) {
        ...
        if (confirm("Are you sure to delete this " + msg + " !")) {
            $.ajax({
                url: base_url + 'parent/calendar/delete_event/' + id,
                type: 'POST',
                //data: '',
                dataType: "json",
                success: function (res) {
